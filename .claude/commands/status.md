...
Then read @dsa-prep/notes/REVIEW.md (the SRS index — do NOT scan the notes folder) and give me a full status report. Do NOT start a revision session.
...
3. Graduated problems from @dsa-prep/notes/GRADUATED.md (if the file exists)
